...
export default function About() {
  return (
    <div id='about' className="relative overflow-hidden bg-slate-950 shadow-lg shadow-cyan-400">
  <div className="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
    <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
      <div className="sm:max-w-lg">
        <h1 className="text-4xl font-bold tracking-tight bg-gradient-to-r from-cyan-500 to-blue-500 text-transparent bg-clip-text  sm:text-6xl ">About Me</h1>
      ...
      <div>
        <div className="mt-10">
          ...
          <a href="#" className="inline-block rounded-md border border-transparent bg-cyan-500 px-8 py-3 text-center font-medium text-white hover:bg-cyan-600">Resume</a>
        </div>
      </div>
    </div>
  </div>
